		...
		?>
					...
					<div id="productcat-<?=$term->slug;?>" class="_menuP__list-block _azbn_productcat-item_list">
						...
						<div id="productcat-<?=$term->slug;?>-scroll" class="scroll-hide _menuP__scroll-hide" >
							<div class="scroll-element _menuP__scroll-element">
								<div class="scroll-overflow _menuP__scroll-overflow">
										...
										<div class="_menuP__item jscart-item " data-jscart-product="<?=$id;?>" data-jscart-taste="0" data-jscart-cost="<?=$cost;?>" data-jscart-title="<?=$title;?>" ><!-- active -->
											<div class="_menuP__item-flex">
												...
												<div class="_menuP__item-qty">
													<span class="qty-minus _menuP__item-qty-btn jscart-remove-btn hover-border" data-jscart-amount="1" >-</span>
													<span class="jscart-item-amount" >0</span>
													<span class="qty-plus _menuP__item-qty-btn jscart-add-btn hover-border" data-jscart-amount="1" >+</span>
												</div>
											</div>
						...
						<div class="scroll-container vertical right" data-target="#productcat-<?=$term->slug;?>" >
